...
:LInitialize
    ...
    set Install=
    set Uninstall=
    set PackageFile=%~dp0FamilyAccountInformationWebPart.wsp
    set PackageName=FamilyAccountInformationWebPart.wsp
...
:LValidate
    ...
    if exist "%SPFeaturesLocation%\FamilyAccountInformation" (
       echo Error: Feature folder FamilyAccountInformation already exists in current SharePoint.
       set ValidationFailed=1
    )

    if exist "%SPTemplateLocation%\CONTROLTEMPLATES\FamilyAccountInformationUserControl.ascx" (
       echo Error: Template file FamilyAccountInformationUserControl.ascx already exists in current SharePoint.
       set ValidationFailed=1
    )

    if exist "%SPTemplateLocation%\CONTROLTEMPLATES\mailPlain.jpg" (
       echo Error: Template file mailPlain.jpg already exists in current SharePoint.
       set ValidationFailed=1
    )
...
:LDeploy
    ...
    echo Activating feature FamilyAccountInformation ...
    "%SPAdminTool%" -o activatefeature -id 7d3458f0-e01d-4329-b993-a36b048200c5 -url %TargetSiteUrl%
...
@rem----------------------------------------------------------------------
:LRetract
    echo Deactivating feature FamilyAccountInformation ...
    "%SPAdminTool%" -o deactivatefeature -id 7d3458f0-e01d-4329-b993-a36b048200c5 -url %TargetSiteUrl% -force

    echo Uninstalling feature FamilyAccountInformation ...
    "%SPAdminTool%" -o uninstallfeature -id 7d3458f0-e01d-4329-b993-a36b048200c5 -force
